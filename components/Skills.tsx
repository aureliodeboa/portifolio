...
const Skills = () => {
  return (
    <section className='max-container padding-container gap-20 py-10 pb-32 md:gap-28 lg:py-20 xl:flex-row'>
      {/*Title */}
      <div className='text-center bold-18 uppercase tracking-[1rem] text-blue-500 pv-20'>Skills </div>
...
const SkillItem = ({ title, icon, description }: SkillItem) => {
  return (
    ...
    <li className=' relative flex w-full flex-1 flex-col items-center text-center shadow-[0 3px 10px rgb(0,0,0.2)] rounded-2xl p-10 hover:bg-blue-500 group duration-[120ms] transition' >
      ...
      <h3 className='bold-20 lg:bold-22 mt-6 capitalize group-jover:text-white'>{title}</h3>
